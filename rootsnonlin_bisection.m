...
## -*- texinfo -*- 
## @deftypefn {} {@var{Aroot}, @var{At} =} rootsnonlin_bisection (@var{A}, @var{Alow}, @var{Aup})
## Solve for the nearest root of nonlinear equation A on the [Alow, Aup] interval
## using bisection method of Bolzano.
## 
...
function [Aroot, At] = rootsnonlin_bisection (A, Alow, Aup)
  i=1;
  while 1
    Ad=(Aup+Alow)/2;
    flow=A(Alow);
